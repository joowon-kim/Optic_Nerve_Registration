...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        sys.stderr.write('Usage: %s filename [mask_filename=filename_on_init.nii.gz [sigma=1] ]\n' % sys.argv[0])
    ...
    run(filename=filename, filename_on_init=filename_on_init, filename_flt=filename_flt, filename_centerline=filename_centerline, filename_centerline_dilated=filename_centerline_dilated, sigma=sigma)
